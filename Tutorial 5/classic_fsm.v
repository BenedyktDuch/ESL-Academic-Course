...
always @(fsm_state) begin: CLASSIC_FSM_LOC_INSTS_CHUNK_INSTS_0_C
    case (fsm_state)
        2'b00: begin
            outputs_o = 1;
        end
...
always @(posedge clk_i) begin: CLASSIC_FSM_LOC_INSTS_CHUNK_INSTS_K
